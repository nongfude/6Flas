...
baselines. 6FLAS matches IPsec/DTLS on authentication, integrity, and anti-replay
while uniquely offering stateless verification and topology-aware access
control; it deliberately omits payload confidentiality, which it leaves to a
composable encryption layer.
...
\toprule
\textbf{Property} & \textbf{IPsec} & \textbf{DTLS} & \textbf{SRv6-HMAC} & \textbf{6FLAS} \\
\midrule
