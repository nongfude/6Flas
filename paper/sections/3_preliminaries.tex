...
neighbors by ISLs. In the common $+$Grid pattern, a satellite maintains four ISLs: two
intra-plane links (forward/backward in the same orbital plane) and two
inter-plane links (to satellites in adjacent planes); together with separate
up and down ground links, this yields \emph{six} forwarding directions per
node (north, south, east, west, up, down).
