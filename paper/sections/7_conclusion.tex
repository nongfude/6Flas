...
bounded by the MAC and the $32$-bit tag. A reproducible processing model, an event-driven model of a 1584-satellite
constellation, and a Python software prototype show 6FLAS cuts per-hop
