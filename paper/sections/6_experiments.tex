...
mechanisms. The reproducible three-part evaluation (analytical processing model,
event-driven latency model, and Python software prototype) and baselines are described first,
...
6FLAS is evaluated with a reproducible three-part model rather than measurements on
